...
Pod::Spec.new do |s|
  s.name             = "DDTAssertLog"
  s.version          = "0.1.0"
  s.summary          = "A short description of DDTAssertLog."
  s.description      = <<-DESC
                       An optional longer description of DDTAssertLog
  ...
  s.source           = { :git => "https://github.com/<GITHUB_USERNAME>/DDTAssertLog.git", :tag => s.version.to_s }
